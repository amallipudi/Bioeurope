  ...
  cy.ntlm(["web04"], Cypress.env("username") , Cypress.env("password"));
   cy.visit("http://web04/")
    ...
    it('verifies the user logged in has the correct name', () => {  
      ...
      cy.origin('https://targray-corp-dev.crm3.dynamics.com', () => { 
        //cy.get('#sitemap-entity-subarea_586631ea > .pa-bm > .pa-eg > .pa-cu').click().wait(10000)
        cy.get("button[aria-label='New DS']").click().wait(10000)
